...
export function registerContentRoutes(app: Express, deps: ContentRouteDeps) {
  ...
  app.get("/api/table/inspiration/:date", async (req: Request, res: Response) => {
    try {
      ...
      return res.json(inspiration || null);
    } catch (error) {
  ...
  app.get("/api/table/inspirations", requireAdminAuth, async (_req: Request, res: Response) => {
    try {
  ...
  app.delete("/api/table/inspiration/:id", requireAdminAuth, async (req: Request, res: Response) => {
    try {
      ...
      return res.json({ message: "Table inspiration deleted successfully" });
    } catch (error) {
  ...
  app.get("/api/marriage-insights", requireAdminAuth, async (_req: Request, res: Response) => {
    try {
  ...
  app.patch("/api/marriage-insights/:id", requireAdminAuth, async (req: Request, res: Response) => {
    try {
      ...
      const insight = await storage.updateMarriageInsight(id, cleanedData as any);
      if (!insight) {
  ...
  app.delete("/api/marriage-insights/:id", requireAdminAuth, async (req: Request, res: Response) => {
    try {
      ...
      cache.clearCategory('marriage-insights');
      return res.json({ message: "Marriage insight deleted successfully" });
    } catch (error) {
  ...
  app.post("/api/torah/pirkei-avot/advance", requireAdminAuth, async (_req: Request, res: Response) => {
    try {
