  ...
  return (
    <>
      ...
      <Dialog open={activeModal === 'emuna'} onOpenChange={() => closeModal(true)}>
        <DialogContent className="max-w-sm w-full bg-gradient-soft border border-blush/20 rounded-3xl p-4 max-h-[95vh] overflow-y-auto platypi-regular shadow-2xl" aria-describedby="emuna-description">
      ...
      <Dialog open={activeModal === 'chizuk'} onOpenChange={() => closeModal(true)}>
        <DialogContent className="max-w-sm w-full bg-gradient-soft border border-blush/20 rounded-3xl p-4 max-h-[95vh] overflow-y-auto platypi-regular shadow-2xl" aria-describedby="chizuk-description">
