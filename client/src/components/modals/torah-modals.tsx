  ...
  return (
    <>
      ...
      <Dialog open={activeModal === 'emuna'} onOpenChange={() => closeModal(true)}>
        <DialogContent className="w-[95vw] max-w-md mx-4 rounded-3xl p-6 max-h-[95vh] overflow-y-auto platypi-regular" aria-describedby="emuna-description">
      ...
      <Dialog open={activeModal === 'chizuk'} onOpenChange={() => closeModal(true)}>
        <DialogContent className="w-[95vw] max-w-md mx-4 rounded-3xl p-6 max-h-[95vh] overflow-y-auto platypi-regular" aria-describedby="chizuk-description">
