  ...
  return (
    <>
      ...
      <Dialog open={activeModal === 'emuna'} onOpenChange={() => closeModal(true)}>
        <DialogContent className="w-[90vw] max-w-md rounded-3xl p-6 max-h-[95vh] overflow-y-auto platypi-regular" aria-describedby="emuna-description">
      ...
      <Dialog open={activeModal === 'chizuk'} onOpenChange={() => closeModal(true)}>
        <DialogContent className="w-[90vw] max-w-md rounded-3xl p-6 max-h-[95vh] overflow-y-auto platypi-regular" aria-describedby="chizuk-description">
