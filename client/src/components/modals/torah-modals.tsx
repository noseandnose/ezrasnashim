  ...
  return (
    <>
      ...
      <Dialog open={activeModal === 'emuna'} onOpenChange={() => closeModal(true)}>
        <DialogContent className="w-full max-w-xs rounded-3xl p-4 max-h-[95vh] overflow-y-auto platypi-regular" aria-describedby="emuna-description">
      ...
      <Dialog open={activeModal === 'chizuk'} onOpenChange={() => closeModal(true)}>
        <DialogContent className="w-full max-w-xs rounded-3xl p-4 max-h-[95vh] overflow-y-auto platypi-regular" aria-describedby="chizuk-description">
