  ...
  return (
    <>
      ...
      <FullscreenModal
        ...
        showCompassButton={fullscreenContent.contentType === 'morning-brochas' || fullscreenContent.contentType === 'mincha' || fullscreenContent.contentType === 'maariv' || fullscreenContent.contentType === 'shacharis'}
        floatingElement={
...
function SpecialTehillimFullscreenContent({ language: _language, fontSize: _fontSize }: { language: 'hebrew' | 'english'; fontSize: number }) {
  ...
  const specialCategories = [
    { title: "Finding a Shidduch", psalms: [32, 38, 70, 71, 72, 82, 121, 124] },
    { title: "Wedding Day", psalms: [19, 33, 45, 49, 128] },
    { title: "Children & Family", psalms: [4, 5, 8, 12, 20, 35, 57, 93, 102, 103, 108, 127, 128, 139, 142] },
    { title: "Healing & Recovery", psalms: [6, 13, 20, 22, 23, 30, 32, 38, 41, 51, 86, 88, 91, 102, 103, 121, 130, 142, 143] },
    { title: "Livelihood & Success", psalms: [4, 23, 24, 34, 36, 41, 57, 62, 65, 67, 85, 104, 108, 112, 121, 122, 136, 144, 145] },
    { title: "Protection & Safety", psalms: [3, 5, 7, 17, 20, 23, 27, 31, 35, 40, 48, 55, 59, 69, 70, 91, 109, 119, 121] },
    { title: "Gratitude & Thanksgiving", psalms: [9, 17, 18, 21, 23, 33, 42, 57, 63, 65, 68, 71, 72, 95, 100, 103, 104, 105, 107, 108, 116, 124, 136, 138, 145, 146, 147, 148, 149, 150] },
    { title: "Help in Difficult Times", psalms: [16, 20, 22, 25, 26, 38, 54, 81, 85, 86, 87, 89, 98, 102, 107, 130, 142] },
    { title: "Teshuvah & Forgiveness", psalms: [25, 32, 47, 51, 90] },
    { title: "Peace & Serenity", psalms: [46, 98, 120] },
    { title: "Torah Study", psalms: [1, 19, 119, 134] },
    { title: "Guidance & Direction", psalms: [16, 19, 139] },
    { title: "Eretz Yisrael & Yerushalayim", psalms: [42, 43, 74, 79, 80, 83, 84, 87, 96, 102, 122, 125, 127, 130, 132, 136, 137, 138, 142] },
    { title: "Longevity & Good Health", psalms: [23, 90, 92] },
    { title: "Safe Travels", psalms: [17, 91] },
    { title: "Mourning & Yahrzeit", psalms: [16, 17, 33, 49, 72, 91, 104, 130] }
  ];
