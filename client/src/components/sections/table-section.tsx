        ...
        <div className="grid grid-cols-2 gap-2 mb-2">
          ...
          >
            ...
            >
              ...
              <p className={`platypi-bold text-[10px] ${!recipeContent ? 'text-gray-500' : 'text-black'}`}>Daily Recipe</p>
            </div>
          ...
          >
            ...
            >
              ...
              <p className="platypi-bold text-[10px] text-black" data-testid="text-marriage-insights-title">Marriage Insights</p>
            </div>
        ...
        <div className="grid grid-cols-2 gap-2 mb-2">
          ...
          >
            ...
            >
              ...
              <p className={`platypi-bold text-[10px] ${!currentLifeClass ? 'text-gray-500' : 'text-black'}`}>Practical Parenting</p>
            </div>
          ...
          >
            ...
            >
              ...
              <p className="platypi-bold text-[10px] text-black">Meditation</p>
            </div>
