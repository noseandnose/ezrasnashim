        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="text-right">
            ...
            <button 
              ...
              className={`flex items-center justify-end space-x-1 hover:bg-white/80 px-2 py-0.5 rounded-xl transition-colors ${(permissionDenied || !coordinates) ? 'animate-pulse border-2 border-blush bg-blush/10' : 'border border-gray-200 bg-white/60'}`}
            >
