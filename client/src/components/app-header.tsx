...
export default function AppHeader() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 bg-gradient-soft px-3 py-2.5 border-0 shadow-none z-40" style={{ paddingTop: 'max(0.625rem, env(safe-area-inset-top))', touchAction: 'pan-y', overscrollBehavior: 'auto' }}>
