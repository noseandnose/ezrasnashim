...
export default function AppHeader() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 bg-gradient-soft px-3 border-0 shadow-none z-40" style={{ paddingTop: 'calc(var(--safe-area-top, 0px) + 0.625rem)', paddingBottom: '0.625rem' }}>
