...
- **Hebrew Text Cleaning Enhancement**: Enhanced text cleaner to remove Hebrew vowel marks (nikud), cantillation marks, and diacritical marks that appear as strange circles/boxes in Koren font, while preserving core Hebrew letters for optimal display (August 14, 2025)
