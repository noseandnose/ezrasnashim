...
- June 30, 2025. Replaced Hebrew font with Secular One throughout application: Updated Google Fonts import to use Secular One font, replaced all david-libre font classes with secular-one-regular class, updated font-hebrew CSS class to use Secular One, ensuring consistent Hebrew typography across all Tehillim, prayers, and religious text components
